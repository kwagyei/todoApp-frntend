...
//    }
  ...
  <div className='row justify-content-center'>
    <div className='col-md-6'>
      <div className='container mt-3'>
        <form onSubmit={handleSubmit}>
          <div className='mb-3 row align-items-center'>
            <label className='col-md-3 col-form-label text-end' htmlFor='todoTask'>
              Task
            </label>
            ...
            <label htmlFor='todoDate' className='col-md-3 col-form-label text-end'>
              Due date
            </label>
            <div className='col-md-9'>
              <input
      ...
      <div className='mt-3'>
        {listOfTodosFromDb.map((item) => (
          <div className='container mb-3 bg-light p-3 rounded' key={item.id}>
            <div>
              <h4>{item.todoTask}</h4>
            </div>
            <div>
            ...
            <div className='text-end'>
              <button onClick={() => handleEdit(item.id)} className='btn btn-info me-1'>
                Edit
              </button>
